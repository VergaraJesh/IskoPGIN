...
<body>
    ...
    <div class="row" align="center">
            ...
            <br>
            <br>
            <b>LIST OF JUNIOR and SENIOR HIGH SCHOOL  <?php if($stype==6): ?> ARTS  <?php else: ?> Agriculture and Fishery <?php endif; ?> APPLICANTS<br>
    ...
    <table class="table table-bordered">
            ...
            <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $users): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>          
                    <tr>
                      ...
                      <td  align="center"> 
                      <?php $__currentLoopData = $users['levelss']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($lv->course!=''): ?>
                            <?php echo e($lv->course); ?>
                      ...
                      <td class="text-center align-middle"><?php echo e(strtoupper($users['gwa'])); ?></td>  
                      <td class="text-center align-middle"><?php echo e(strtoupper($users['ped'])); ?></td> 
                      <td class="text-center align-middle"><?php echo e($users['tots']); ?></td> 
                  </tr>              
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
          </table>
