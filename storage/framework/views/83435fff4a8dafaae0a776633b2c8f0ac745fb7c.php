...
<form method="post" action="<?php echo e(route('student.screcordresult2')); ?>" target="_blank">
      <br><br>
      ...
      <div class="form-group col-md-3">
                  <div class="form-group">
                      ...
                      <select id="sy2" name="sy2" class="form-control">
                          ...
                          <?php $__currentLoopData = $sy2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
