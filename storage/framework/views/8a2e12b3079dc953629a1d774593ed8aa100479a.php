...
<body>
    ...
    <div class="row" align="center">
            ...
            <br>
            <br>
            <b>LIST OF  <?php if($stype==1): ?> ACADEMIC  <?php else: ?> SENIOR HIGH SCHOOL <?php endif; ?> APPLICANTS<br>
    ...
    <table class="table table-bordered">
            ...
            <?php endif; ?>         
                    <tr>
                      ...
                      <?php if($stype==4): ?>
                      <td class="text-center align-middle"><?php echo e(strtoupper($users['mother'])); ?></td>
                      <td class="text-center align-middle"><?php echo e(strtoupper($users['father'])); ?></td> 
                      <td class="text-center align-middle"><?php echo e(strtoupper($users['guardian'])); ?></td>   
                      <?php endif; ?>
                  </tr>              
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
