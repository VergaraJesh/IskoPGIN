...
<form method="post" action="<?php echo e(route('student.lgugoresult')); ?>" target="_blank">
    <div class="row">
            <div class="col-md-1">
                </div>
        ...
        <div class="col-md-1">
          ...
          <label for="skol">Senior High School</label>
           <select id="skol" name="skol" class="form-control">
                      <option value="">- Select-SY -</option>
                      <?php $__currentLoopData = $skol; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($skol->id); ?>"><?php echo e($skol->name); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
        </div>
