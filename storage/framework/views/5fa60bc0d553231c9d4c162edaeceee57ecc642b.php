  ...
  <form id="regForm" method="POST" action="/student">
        ...
        <div class="col-md-12" align="center">
         ...
         <label class="radio-inline">
          ...
          <label class="radio-inline">
            ...
            <label class="radio-inline">
              <input type="radio" id="scholarship" name="scholarship" value="7" checked="true">
              <b>Agriculture</b>
            </label>
          </h5>
        </div>
       ...
       <div class="row">
          ...
          <div class="form-group col-md-3">
           ...
           <div class="form-group col-md-2">
              ...
              <input id="gwa" name="gwa" class="form-control mx-sm-1" value="0">
             </div>
       </div>
    ...
    <div class="tab" >
      ...
      <div class="row">
        ...
        <div class="col-md-3">
           <input name="sname<?php echo e($i); ?>" id="sname<?php echo e($i); ?>" class="form-control mx-sm-3" placeholder="Sibling Name">
          </div>
        <div class="col-md-1">
           <input name="sage<?php echo e($i); ?>" id="sage<?php echo e($i); ?>" class="form-control mx-sm-1" placeholder="0">
          </div>
        <div class="col-md-2">           
            <select id="saddress<?php echo e($i); ?>" name="saddress<?php echo e($i); ?>" class="form-control">
                    <option value="">- Select Town -</option>
                    <?php $__currentLoopData = $town1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($key); ?>"><?php echo e($value); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-md-2">
           <input name="scontact<?php echo e($i); ?>" id="scontact<?php echo e($i); ?>" class="form-control mx-sm-1" placeholder="09" type="hidden">
          </div>
        <div class="col-md-2">
            <input class="form-control" id="soccupation<?php echo e($i); ?>" name="soccupation<?php echo e($i); ?>" placeholder="Sibling Occupation" type="hidden">
          </div>
        </div>
        <?php endfor; ?>
    ...
    <div class="tab" >
      ...
      <div class="row">
          ...
          <div class="form-group col-md-2">
              <div class="form-group">
               ...
               <select id="tvcoll" name="tvcoll" class="form-control">
                 ...
                 <option value="DATA">Data Center College of the Philippines</option>  
        ...
        <div class="form-group col-md-4">
            <label for="coursedom">Tertiary(DoM/LAW)</label>
        ...
        <div class="form-group col-md-4">
          ...
          <div class="form-group col-md-2">
           <div class="form-group">
            <label for="domspe">Specialization(DoM/LAW)</label>
            <input id="domspe" name="domspe" class="form-control mx-sm-3" placeholder="School in Tertiary..">
          </div>
          </div>         
        </div>
        <div class="row">
        ...
        <div class="form-group col-md-4">
           <div class="form-group">
            <label for="lawschool">School (LAW)</label>
            <input id="lawschool" name="lawschool" class="form-control mx-sm-3" placeholder="Law School attending..">
          </div>
          </div>                   
        </div>
        <div class="row">
