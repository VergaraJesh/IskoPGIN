...
@section('content')
		<div class="container" >
			...
			<div class="row">
				...
				<div class="col-md-2">
					<b>Interview(PEDO):</b> {{$student->result_interview}}%
					</div>
					<div class="col-md-2">
						<b>Interview(INYDO):</b> {{$student->result_interview1}}%
						</div>
				<div class="col-md-2">
					...
					<div class="form-group col-md-3">
							<div class="form-group">
									<div class="input-group">
											...
											<input type="number" step=".01" id="inter1" name="inter1" class="form-control mx-sm-1" placeholder="0.00" value="{{$student->result_interview1}}">
										  </div>
								</div>
							</div>
