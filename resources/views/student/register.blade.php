  ...
  <form id="regForm" method="POST" action="/student">
    ...
    <div class="tab" >
      ...
      <div class="row">
        ...
        <div class="col-md-2">
           <input name="scontact{{$i}}" id="scontact{{$i}}" class="form-control mx-sm-1" placeholder="09" type="hidden">
          </div>
        <div class="col-md-2">
            <input class="form-control" id="soccupation{{$i}}" name="soccupation{{$i}}" placeholder="Sibling Occupation" type="hidden">
          </div>
        </div>
        @endfor
