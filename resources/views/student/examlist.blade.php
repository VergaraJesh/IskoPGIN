...
@section('content')
<h2>Display Exam Report</h2>
<form method="post" action="{{ route('student.exresult') }}" target="_blank">
    <div class="row">
            <div class="col-md-1">
                </div>
            <div class="col-md-6" align="center">
                   ...
                   <label class="radio-inline">
                    ...
                    <label class="radio-inline">
                            <input type="radio" id="scholarship" name="scholarship" value="7" onclick="TechVoc()">
                            <b>Agri</b>
                          </label>
                    <label class="radio-inline">
     ...
     <div class="row">
        <div class="col-md-2">
          ...
          <div class="form-group col-md-2">
              ...
              <input class="datepicker1 form-control" type="date" id="dt" name="dt">  
              </div>
        </div>
