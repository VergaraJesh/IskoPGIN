...
<body>
    ...
    <div class="row" align="center">
            ...
            <br>
            <br>
            <b>LIST OF JUNIOR and SENIOR HIGH SCHOOL  @if($stype==6) ARTS  @else Agriculture and Fishery @endif APPLICANTS<br>
    ...
    <table class="table table-bordered">
            ...
            @foreach($students as $users)          
                    <tr>
                      ...
                      <td class="text-center align-middle">{{ strtoupper($users['gwa']) }}</td>  
