...
<div class="container">
	...
	<form id="regForm" method="POST" action="{{ route('student.update',[$student->id])}}" enctype="multipart/form-data">
		{{ csrf_field()}}
		...
		<div class="form-group col-md-3">
           ...
           <input id="fname" name="fname" class="form-control mx-sm-3 " placeholder="{{ $student->fname}}" >
          </div>
        <div class="form-group col-md-1">
           <label for="mi">M.I.</label>
           <input id="mi" name="mi" class="form-control mx-sm-1" placeholder="{{ $student->mname}}">
          </div> 
          <div class="form-group col-md-3">
            <label for="lname">Last Name</label>
            <input  class="form-control" id="lname" name="lname" placeholder="{{ $student->lname}}">
          </div>
          <div class="form-group col-md-1">
          ...
          <div class="row">
	          ...
	          <input class="datepicker1 form-control" type="date" id="dob" name="dob" value="{{$student->dob}}">  
	          </div>
        <div class="form-group col-md-4">
           <label for="contact">Contact Number</label>
           <input id="contact" name="contact" class="form-control mx-sm-3" placeholder="{{$student->contact}}" min="0" max="13">
          </div>
        <div class="form-group col-md-4">
           <label for="contact1">Alternate Contact</label>
           <input id="contact1" name="contact1" class="form-control mx-sm-3" placeholder="{{$student->contact1}}" min="0" max="13">
          </div>
      		</div>
        ...
        <div class="row">
            <div class="form-group col-md-4">
               ...
               <input type="email" id="email" name="email" class="form-control mx-sm-3" placeholder="{{$student->email}}">
              </div> 
              <div class="form-group col-md-4">
               <label for="email">Alternate Email</label>
               <input type="email" id="email1" name="email1" class="form-control mx-sm-3" placeholder="{{$student->email1}}">
              </div> 
              <div class="form-group col-md-2">
          ...
          <div class="row">
                <div class="form-group col-md-4">
                        ...
                        <select id="hs" name="hs" class="form-control">
                            <option value="">-Select-</option>
                            @foreach ($shscl as $shs1)
                                <option value="{{$shs1->id}}">{{ $shs1->name }}</option>
                            @endforeach
                            </select>
                       </div>
                     <div class="form-group col-md-1">
